      ...
      <div className="grid grid-cols-1 sm:grid-cols-12">
        ...
        >
          <h1 className="text-white mb-4 text-4xl sm:text-5xl lg:text-8xl lg:leading-normal font-extrabold">
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#ee0979] to-[#ff6a00]">
              Hello, I&apos;m{" "}
            </span>
            <br></br>
            <TypeAnimation
          ...
          <div>
            <Link
              href="/#contact"
              className="px-6 inline-block py-3 w-full sm:w-fit rounded-full mr-4 bg-gradient-to-br from-[#ee0979] to-[#ff6a00] hover:bg-slate-200 text-white"
            >
              Hire Me
            </Link>
            <Link
