        ...
        <ul className="timeline">
          <li className="timeline-item">
            ...
            <div className="timeline-content">
              ...
              <p>
                I graduated after 6 months of studying. I immediately found a
          ...
          <li className="timeline-item">
            ...
            <div className="timeline-content text-right">
              ...
              <p>
                I worked as a front-end developer for 2 years in 1 job and 1
                year in another job. I also upskilled to the full stack.
              </p>
            </div>
          </li>
          <li className="timeline-item">
